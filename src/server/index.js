...
server.post('/api/reason', function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var body;
    return __generator(this, function (_a) {
        body = request.body;
        return [2 /*return*/, {
                ...
                response: "Autonomous reasoning processed: \"".concat((body === null || body === void 0 ? void 0 : body.prompt) || 'No prompt provided', "\""),
                timestamp: new Date().toISOString()
            }];
    });
}); });
try {
    ...
    console.log("RyanAI API Gateway listening on http://0.0.0.0:".concat(PORT));
}
catch (err) {
