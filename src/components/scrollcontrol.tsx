  ...
  return (
    <div className={`absolute bottom-6 right-6 z-20 ${className}`}>
      <button
        ...
        className="flex items-center justify-center w-10 h-10 bg-neutral-800 hover:bg-neutral-700 text-neutral-200 rounded-full shadow-lg border border-neutral-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500"
      >
