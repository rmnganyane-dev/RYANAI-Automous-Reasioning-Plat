          ...
          <div className="flex gap-2 items-center">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-ink-900/40 border border-cyan-500/15 rounded-lg pl-8 pr-3 py-1.5 text-xs text-ink-200 placeholder:text-ink-600 focus:outline-none focus:border-cyan-500/40"
              />
            </div>
            <select
              value={selectedCategoryFilter}
              onChange={(e) => setSelectedCategoryFilter(e.target.value)}
              className="bg-ink-900/40 border border-cyan-500/15 rounded-lg px-2.5 py-1.5 text-xs text-ink-300 focus:outline-none focus:border-cyan-500/40 font-mono"
            >
        ...
        <div className="space-y-2 max-h-64 overflow-y-auto pr-1">
          ...
          {filteredEntries.map((entry) => {
            ...
            return (
              <div
                key={entry.id}
                className="group flex items-start gap-3 bg-ink-800/30 rounded-lg p-3 border border-cyan-500/10 hover:border-cyan-500/25 transition-colors"
              >
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 text-ink-600 hover:text-rose-400 transition-all p-1"
                  title="Delete memory"
                >
                  <Trash2 size={13} />
                </button>
