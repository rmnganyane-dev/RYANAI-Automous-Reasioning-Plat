...
export const ChatStream: React.FC = () => {
  ...
  return (
    <div className="relative h-[600px] overflow-hidden flex flex-col bg-neutral-900 border border-neutral-800 rounded-lg">
      <div ref={containerRef} className="flex-1 overflow-y-auto p-4 space-y-3">
        {messages.map((msg, idx) => (
          <div key={idx} className="p-3 bg-neutral-800 text-neutral-100 rounded-md text-sm font-mono">
            {msg}
          </div>
        ))}
